...
function currentLine(katzDeliLine){if(katzDeliLine.length===0){return(`The line is currently empty.`)}else{var katzDeliIndex=[]; for(let i=0;i<katzDeliLine.length;i++){katzDeliIndex.push(` ${(i+1)}. ${katzDeliLine[i]}`)};return(`The line is currently:${katzDeliIndex}`)}}
