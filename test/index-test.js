...
describe('deli', () => {
  describe('takeANumber', () => {
    ...
    console.log('adds a person to the line', () => {
      expect(takeANumber(katzDeli, 'Ada')).toEqual("Welcome, Ada. You are number 1 in line.");
      expect(katzDeli).toEqual(['Ada']);
    });

    console.log('appends the person the end of the line if there are already people on it', () => {
    ...
    console.log("properly handles multiple people being added", () => {
  ...
  describe('nowServing', () => {
    console.log('returns the line is empty when no one is on line', () => {
      expect(nowServing([])).toEqual("There is nobody waiting to be served!");
    });

    console.log('returns an announcement about the person it is serving, and shifts the line', () => {
  ...
  describe('currentLine(line)', () => {
    console.log('returns "The line is currently empty." if no one is in line', () => {
      expect(currentLine([])).toEqual("The line is currently empty.");
    });

    console.log('says who is in line when there are people waiting', () => {
